...
papp_cloud rsync bscc-a3:$syncFolderPath/postProcess/images/*10.15* ./postProcess/images/
papp_cloud rsync bscc-a3:$syncFolderPath/postProcess/10.15.csv ./postProcess/rawdata/
