...
papp_cloud rsync bscc-a3:$syncFolderPath/postProcess/images/*2.01* ./postProcess/images
papp_cloud rsync bscc-a3:$syncFolderPath/postProcess/images/*4.51* ./postProcess/images
papp_cloud rsync bscc-a3:$syncFolderPath/postProcess/2.01.csv ./postProcess/rawdata/
papp_cloud rsync bscc-a3:$syncFolderPath/postProcess/4.51.csv ./postProcess/rawdata/
